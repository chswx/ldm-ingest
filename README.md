...
[![Build Status](https://travis-ci.org/jaredwsmith/ldm-ingest.svg?branch=master)](https://travis-ci.org/jaredwsmith/ldm-ingest) (test suite in progress, don't read much into this yet!)
