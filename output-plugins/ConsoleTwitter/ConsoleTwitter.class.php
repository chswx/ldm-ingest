...
/*
 * "Console Twitter"
 * Emulates the generation and output of a tweet to the console
 */

class ConsoleTwitterListener extends Listener implements ListenerInterface
{
