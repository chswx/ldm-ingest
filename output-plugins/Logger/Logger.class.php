...
// Plain English definitions for logging levels
define('LDM_DEBUG',0);
define('LDM_INFO',1);
define('LDM_NOTICE',2);
define('LDM_WARNING',3);
define('LDM_ERROR',4);
define('LDM_CRITICAL',5);

class Logger extends Listener implements ListenerInterface
{
    ...
    public function publish(Event $event) {
        ...
        if(file_exists(LOGFILE_PATH) && $event->eventName >= LDM_ERROR) {
